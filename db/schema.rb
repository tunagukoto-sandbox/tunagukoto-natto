...
ActiveRecord::Schema.define(version: 2020_12_24_042055) do
  ...
  create_table "events", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.text "url_form_to_com"
    t.string "event_place_title"
    t.integer "pay_point_by_adult"
    t.boolean "un_open"
    t.text "free_box"
  end
  ...
  create_table "mini_question_student_groups", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "mini_questions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "student_id"
    t.boolean "check"
    t.text "menber_name"
    t.integer "year"
